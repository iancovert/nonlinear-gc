...
# Prepare filename
experiment_base = 'Medium VAR LSTM Encoding'
results_dir = 'Results/' + experiment_base

experiment_name = results_dir + '/expt'
experiment_name += '_lam=%e_nepoch=%d_lr=%e_seed-%d_arch-%d.out' % (lam, nepoch, lr, seed, arch)
...
# Prepare data
X, _, GC = long_lag_var_model(0.3, 10, 1.0, 1.0, 1000, lag = 3)
